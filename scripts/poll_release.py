...
GITHUB_REPOSITORY = os.environ.get("GITHUB_REPOSITORY", "magrathean-uk/auditex.hu")
RELEASE_TAG = os.environ.get("RELEASE_TAG", "deploy-main")
GITHUB_TOKEN = os.environ.get("GITHUB_TOKEN", "")
STATE_FILE = Path(os.environ.get("DEPLOY_STATE_FILE", "/opt/sites/auditex/runtime/last_release"))
DEPLOY_SCRIPT = os.environ.get("DEPLOY_SCRIPT", "/opt/sites/auditex/deploy.sh")
